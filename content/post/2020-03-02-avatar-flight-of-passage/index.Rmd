...
image:
  caption: View of Avatar Flight of Passage queue
  focal_point: Center
  placement: 2
  preview_only: no
projects: []
...
knitr::include_graphics("fig01_forecast_plot.png", dpi = 400)
```
...
It appears the best time to ride Avatar Flight of Passage is right when the park opens on a Wednesday in September!  If you can't manage to go to Disney's Animal Kingdom, you can still enjoy the beautiful scenery of the World of Pandora while you wait!
```{r echo = FALSE}
