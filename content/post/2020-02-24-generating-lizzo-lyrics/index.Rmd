...
![Lizzo](https://media.giphy.com/media/lOsqt7K4G9T3RNBT7D/giphy.gif)
...
Ltweet %>%
  ...
  ggplot2::labs(
    x = NULL, y = NULL,
    title = "Frequency of #Lizzo Twitter statuses from past 9 days",
    subtitle = "Twitter status (tweet) counts aggregated using three-hour intervals",
    caption = "\nSource: Data collected from Twitter's REST API via rtweet"
  )
```

![Lizzo tweet plot](Lizzo_tweet_plot.png) 
...
knitr::include_graphics("Lizzo_tweet_plot.png")
```

## Using Genius to get lyrics  

We can use the [genius package](https://github.com/JosiahParry/genius) to query music lyrics in R.  We use the command `genius_lyrics()` and to anlayze the lyrics from a song and artist.  Next we can use Julia Silge and David Robinson's  [tidytext package](https://github.com/juliasilge/tidytext)  to unnest tokens and obtain 2-word "ngrams".  We will use this later on to make our Markov chain generator.
```{r}
...
```
It seems like there's plenty of of "love" and positive word sentiment in this album!

![Lizzo love](https://media.giphy.com/media/IzinVgJa1SITQ44YNS/giphy.gif)  
...
```{r eval=FALSE, include=FALSE}
# image_write(Lizzo_meme, path = "featured.png", format = "png", quality = 800)
